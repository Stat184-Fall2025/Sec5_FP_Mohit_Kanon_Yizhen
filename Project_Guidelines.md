...
- [x] Create a repo using the template repo. Name your repo `Sec#_FP_Name1_Name2_Name3` where `Sec#` is your section of Stat184 (i.e., `Sec1`, `Sec2`, `Sec3`, or `Sec5`) and `Name#` is replaced with the names of each team member.
  - [x] The owner of the repo should be `Stat184-Fall2025`. 
